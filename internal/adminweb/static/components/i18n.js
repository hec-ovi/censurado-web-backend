...
export const ES = {
  ...
  // --- Articles panel ---------------------------------------------------
  "The hero image lives in metadata.image (a /media path or an http(s) URL), never as a top-level field.":
    "La imagen principal vive en metadata.image (una ruta /media o una URL http(s)), nunca como campo de nivel superior.",
  "New article": "Nuevo artículo",
  "Article sections": "Secciones de artículos",
  "Article editor": "Editor de artículo",
  "Deleted articles": "Artículos eliminados",
  "No deleted articles.": "No hay artículos eliminados.",
  Title: "Título",
