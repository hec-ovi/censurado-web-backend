...
var panelTextSeed = []PanelTextSeedEntry{
	...
	{"A monthly schedule needs at least one day of the month.", "A monthly schedule needs at least one day of the month.", "Una tarea mensual necesita al menos un día del mes."},
	...
	{"Active", "Active", "Encendido"},
	{"Active fires on schedule; switched off it stays listed but never fires (paused).", "Active fires on schedule; switched off it stays listed but never fires (paused).", "Encendido dispara según la tarea programada; apagado queda en la lista y no dispara."},
	...
	{"Article edition", "Article edition", "Edición de artículos"},
	...
	{"Could not load schedules: {msg}", "Could not load schedules: {msg}", "No se pudieron cargar las tareas: {msg}"},
	...
	{"Loading schedules...", "Loading schedules...", "Cargando tareas..."},
	...
	{"New schedule", "New schedule", "Nueva tarea"},
	...
	{"Schedule", "Schedule", "Tarea"},
	{"Schedule editor", "Schedule editor", "Editor de tarea"},
	{"Schedules", "Schedules", "Tareas"},
	...
	{"Title", "Title", "Título"},
	{"Topic normalization", "Topic normalization", "Normalización de temas"},
	{"Topics", "Topics", "Temas"},
